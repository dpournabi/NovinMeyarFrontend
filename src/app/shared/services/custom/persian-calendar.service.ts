...
export class PersianCalendarService {
    ...
    PersianCalendar(gregorianDate, type?: string): string {
        ...
        switch (type) {
            case 'fullDate':
                returnDate = this.strWeekDay + " " + this.day + " " + + " " + this.year;
                break;
            case 'year':
                returnDate = this.year.toString();
                break;

            case 'mounth':
                returnDate = this.strMonth;
                break;

            case 'day':
                returnDate = this.strWeekDay;
                break;
        }
    ...
    toPersian(gregorianDate) {
        ...
        this.WeekDay = this.WeekDay > 6 ? this.WeekDay - 7 : this.WeekDay;
